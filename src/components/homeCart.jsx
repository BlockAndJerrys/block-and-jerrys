...
class HomeCart extends React.Component {
  ...
  render() {
    ...
    const price = this.state.currency === 'BTC' ? ((this.props.cartTotal / this.props.btcPrice).toFixed(0)) + ' Satoshis' : '$' + (this.props.cartTotal.toFixed(0));
        ...
        <div style={contentStyle}>
          ...
          <div style={{ marginTop: '35px' }}>
            ...
            <RaisedButton
              ...
              disabled={this.props.quantity === 0 || stepIndex === 2 || ((!this.props.name || !this.props.address || !this.props.phone) && stepIndex === 1)}
              primary
